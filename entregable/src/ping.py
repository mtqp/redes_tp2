...
class Ping:
    ...
    def alphas(self, alpha_pace):
        return numbers(0.0, 1.0, alpha_pace)
...
class Statistic:
    ...
    def ping_avg(self):
        return float(self.ellapsed_sum) / float(self.succeeded_count)
    ...
    def output(self):
        print str(self.ip) + ',' + str(self.alpha) + ',' + str(self.total()) + ',' + str(self.failed_count) + ',' + str(self.succeeded_count)  + ',' + str(self.loss_probability()) + ',' + str(self.ertt) + ',' + str(self.ping_avg()) + ',' + str(self.throughtput())
...
if (len(sys.argv) < 4):
    ...
    statistics = ping.do()
    print 'ip,alpha,total,failed,succeeded,lossProbability,ertt,rttAvg,throughput'
